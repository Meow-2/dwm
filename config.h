...
static const Rule rules[] = {
    ...
    {"Code",                 "code",               NULL,             1 << 7,         0,           1,        -1 },
    {"jetbrains-pycharm",    NULL,                 NULL,             1 << 7,         1,           1,        -1 },
...
static Key keys[] = {
    ...
    { ControlMask|ShiftMask,XK_Escape,   spawn,            SHCMD("~/Programs/dwm/scripts/app-starter.sh terminal btop") },
